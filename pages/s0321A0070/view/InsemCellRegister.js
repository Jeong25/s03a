...
import { retrieveInsemCellCustMob, retrieveWorker, updateInsemCellCustMob } from '../../common/repository/repository';
import { styleSheet } from './stylesheet';

const InsemCellRegister = (props) => {
  ...
  const getData = async () => {
    ...
    try {
      ...
      const res2 = await retrieveInsemCellCustMob(hospId, props.route.params?.custOpId, props.route.params?.opWorkEvent)
      if (res2 === null) {
  ...
  return (
    <View style={styles.wrap}>
      <View style={styles.topMenu}>
        ...
        <Text style={styles.pageTitle}>수정세포 등록</Text>
      </View>
      <ScrollView
...
export default InsemCellRegister

InsemCellRegister.defaultProps = {
